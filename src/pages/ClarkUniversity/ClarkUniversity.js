...
import BA from '../../assets/universityLogoImage/CU-01.svg';
import Topimg from '../../assets/LandingPage/top-img.svg'
import topimg2 from '../../assets/LandingPage/top-img.png'
import samplecaf from '../../assets/catificates/MGR.University.sample certificate.jpeg'
import './ClarkUniversity.css'
                                    ...
                                    <div className="col-lg-7">
                                        <div className="bharathidasnuniversity-content">
                                            <div className="logos" style={{ display: "flex", justifyContent: "center" }}>
                                                <img src={BA} style={{ width: "30%" }}></img>

                                            </div>
                                            <div className="p-content">
                                                <p>
                                                    {university[0]?.content}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-12 mt-3">
                                                        <div style={{ textAlign: "start", fontSize: "10px" }}>
                                                            ...
                                                            I authorize Clark University's and its associates to contact me with updates & notifications via email, SMS, WhatsApp, and voice call. This consent will override any registration for DNC / NDNC.
                                                        </div>
                                                    </div>
...
export default ClarkUniversity