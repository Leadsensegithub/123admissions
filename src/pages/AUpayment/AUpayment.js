...
import './AUpayment.css';
import AN from '../../assets/bot/an.png';
    ...
    const handlePayment = async () => {
        ...
        if (valid == true) {
            ...
            const options = {
                ...
                image: 'https://api.123admissions.com/uploads/UniversityLogo/1717047631286_Andhra%20University.png',
                order_id: order.id,
    ...
    return (
        <>
            <div className="AUpaymentmain">
                <h3>Secure payment page (Andhra University)</h3>
                <div className="AUpayment">
                    <div className="payment-ui">
                        <div className="row">
                            <div className="col-lg-12 col-12">
                                <img src={AN} alt="AN Logo" />
                            </div>
                ...
                <h3 style={{ marginTop: "0px" }} className="h2tag">Now your are Paying for Andhra University</h3>
            </div>
        </>
    );
};
