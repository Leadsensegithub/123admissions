        ...
        >
            <Modal.Body className="text-center formmodle_body">
                {tankyou ? <div className="row">
                    ...
                    <div className="row" style={{ textAlign: "center", padding: "15% 20px" }}>
                        <div>
                            <h1 style={{ color: "var(--green1)" }}>Thank You for Your Interest!</h1>

                            <p>Your information has been received successfully. Our team will review your submission and get back to you shortly. In the meantime, feel free to explore our website to learn more about our courses and programs.</p>


                            <button className="btn btn-primary" onClick={Closehandle}>Continue Exploring Button</button>
                        </div>
                    </div>
                </>}
            </Modal.Body>
